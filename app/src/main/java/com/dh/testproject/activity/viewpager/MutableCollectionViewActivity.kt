...
class MutableCollectionViewActivity : MutableCollectionBaseActivity() {
    ...
    override fun createViewPagerAdapter(): RecyclerView.Adapter<*> {
        ...
        return object : RecyclerView.Adapter<PageViewHolder>() {
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PageViewHolder {
                return PageViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_mutable_collection, parent, false))
            }
            ...
            override fun onBindViewHolder(holder: PageViewHolder, position: Int) {
                ...
                //holder.bind(items.getItemById(items.itemId(position)), clickHandler, clickCountProvider)
    ...
    internal class PageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
